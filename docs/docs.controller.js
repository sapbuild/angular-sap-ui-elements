...
// @ngInject
module.exports = function ($scope, uiError, httpError) {
    ...
    $scope.openHttpErrorMultiple = function (  ) {
        var req = {config : {}, headers : {}, status : '500', statusText : 'Internal Server Error'};
        data = {
            "error" : {
                "code"    : "501",
    ...
    $scope.openHttpErrorAutoClose = function (text, timeout) {
        var title = {msg1 : 'This is the Title'};
        httpError.create({
            content: text,
            title: title,
    ...
    $scope.aVideoSliderItems = [{
        ...
        description: 'This short video gives an introduction to the User Research capabilities of BUILD',
        src: 'https://www.youtube.com/embed/Q6N2cqf6V90'
    }, {
        title: 'Using Questions in BUILD User Research',
        description: 'This short video tutorial gives an overview of how to use questions when creating User Research studies in BUILD',
        src: 'https://www.youtube.com/embed/Do3OmR_CrR8'
    }, {
        title: 'Using Tasks in BUILD User Research',
        description: 'This short video tutorial gives an overview of how to use questions when Using Tasks in BUILD User Research',
        src: 'https://www.youtube.com/embed/h--rx-bgmMI'
    }, {
        title: 'Previewing and Publishing your BUILD User Research Study',
        description: 'This short video tutorial gives an overview of how to use preview and publish your studies when using User Research in BUILD',
        src: 'https://www.youtube.com/embed/0KdWkj_RO5I'
    }, {
        title: 'Participating in BUILD User Research Studies',
        description: 'This short video tutorial gives an overview of how to use preview and publish your studies when using User Research in BUILD',
    ...
    $scope.handyTipText = "This is what a handy tip will look like";
};
