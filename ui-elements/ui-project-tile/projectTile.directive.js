 ...
 * @param {string} createAction The function to be executed when the user is clicks off the tile while creating it
 * @param {string} isBinaryImage A true/false string indicating whether image is a base64 to be loaded
 * @example
